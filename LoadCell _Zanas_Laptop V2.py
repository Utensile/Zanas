...
def open_serial_port():
    ...
    try:
        ...
        timeLabel=cTk.CTkLabel(dataFrame, text="Time: ", text_color=txt_color_light, font=TextFontL)
        timeLabel.grid(row=4, column=0, padx=20, pady=15)
        gLabel=cTk.CTkLabel(dataFrame, text="0.00 g", text_color=txt_color_light, font=TextFontL)
        gLabel.grid(row=0, column=1, padx=20, pady=15)
        NLabel=cTk.CTkLabel(dataFrame, text="0.000 N", text_color=txt_color_light, font=TextFontL)
        NLabel.grid(row=1, column=1, padx=20, pady=15)
        maxfLabel=cTk.CTkLabel(dataFrame, text="0.000 N", text_color=txt_color_light, font=TextFontL)
        maxfLabel.grid(row=2, column=1, padx=20, pady=15)
        iLabel=cTk.CTkLabel(dataFrame, text="0.000 N*s", text_color=txt_color_light, font=TextFontL)
        iLabel.grid(row=3, column=1, padx=20, pady=15)
        tLabel=cTk.CTkLabel(dataFrame, text="0.000 s", text_color=txt_color_light, font=TextFontL)
